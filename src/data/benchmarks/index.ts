...
export const taxHarness: DomainBoard = {
  ...
  category: 'Finance',
  blurb: 'The same TY2024 returns, run through real coding harnesses (Claude Code, OpenCode) instead of a raw model call. The agentic harness beats the raw model by 10 to 23 points.',
  benchSource: 'Proprietary',
  target: 0.8,
  metricLabel: 'By-line accuracy',
