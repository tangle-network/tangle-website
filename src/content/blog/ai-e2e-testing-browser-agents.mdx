...
Tangle Browser Agent keeps this close to browser automation standards such as [WebDriver](https://www.w3.org/TR/webdriver2/) and [Playwright](https://playwright.dev/docs/intro), then adds a goal loop for flows that are hard to encode as selectors.
