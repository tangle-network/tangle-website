---
title: 'How AI Agents Discover Products: llms.txt, Manifests, OpenAPI, and Package READMEs'
slug: how-ai-agents-discover-products
summary: >-
  AI agents discover products through stable URLs, scoped packages, safe discovery calls, OpenAPI files, manifests, and READMEs they can verify before writing code.
date: '2026-06-17'
author: Drew Stone
tags:
  - agents
...
For Tangle, that means linking the same surfaces from docs, blog posts, package READMEs, and manifests. The current entry points are [Tangle Sandbox](/services/sandbox), [Browser Agent](/services/browser-agent), and [Blueprint Agent](/services/blueprint-agent).
