...
Begin with the public discovery documents linked below. A machine-readable manifest, an API description, and a health result give an agent enough information to decide whether to continue.
...
The highest-use edits are usually boring:
