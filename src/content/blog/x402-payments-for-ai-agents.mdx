...
Use x402 when a service should be callable and payable by software. Pair it with [Blueprint Agent](/services/blueprint-agent), [Tangle Sandbox](/services/sandbox), and explicit result verification before taking real money in production.
