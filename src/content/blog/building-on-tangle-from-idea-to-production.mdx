...
The previous posts covered [why decentralized infrastructure matters](/post/why-ai-infrastructure-needs-decentralization) and [how verification works](/post/how-tangle-verifies-work). This one is practical: how do you actually build something?
...
When you build on Tangle, you're creating a **blueprint**: a template that defines a type of service. For a deeper look at blueprint architecture, see [How Blueprints Work](/post/how-blueprints-work). Operators register to run your blueprint. Customers pay to use instances of your service. You earn a share of every transaction.
