...
[Browser Agent](https://github.com/tangle-network/browser-agent-driver) supplies the agentic browser run and evidence capture. Sandbox supplies the isolated workspace for app code, test dependencies, and artifacts. For broader browser automation, read [browser automation for AI agents](/blog/browser-automation-for-ai-agents).
