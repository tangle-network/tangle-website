---
title: 'AI Agent Sandbox: What an LLM Sandbox Environment Must Actually Provide'
...
This is why [Browser Agent](/services/browser-agent) and Sandbox fit together. Browser Agent can prove UI state; Sandbox can host the working directory, tools, and process tree around that browser run.
