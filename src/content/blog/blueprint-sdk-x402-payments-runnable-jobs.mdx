...
summary: >-
  How Blueprint SDK translates x402 HTTP payment headers into standard JobCalls,
  so you write your handler once and accept payments from any chain.
date: '2026-03-18'
author: Drew Stone
tags:
  - x402
...
For infrastructure operators [building AI services on Tangle](/blog/building-ai-services-on-tangle), this overhead is significant. You want to expose a compute job over HTTP and get paid for it. You don't want to run a SaaS billing platform on the side.
...
For operators running AI agent services, the billing system is the blockchain, the API key is a wallet, and the invoice is a transaction receipt. To understand how Tangle [verifies work](/blog/how-tangle-verifies-work) beyond payment settlement, that post covers the full verification stack.
