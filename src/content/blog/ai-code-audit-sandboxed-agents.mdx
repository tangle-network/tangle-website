...
This is closer to an audit workflow than a scanner workflow. Scanners such as [CodeQL](https://codeql.github.com/docs/) and [Semgrep](https://docs.semgrep.dev/) are useful tools. The agent's job is to use tools, inspect context, and prove or discard hypotheses.
