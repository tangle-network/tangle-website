...
Start with the Router manifest, API description, health result, and model list linked below. Those public surfaces are enough to decide whether the router fits before writing integration code.
