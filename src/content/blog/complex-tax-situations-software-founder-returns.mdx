...
The founder should see the route as well as the final return. A useful dashboard can label facts as accepted, needs taxpayer answer, needs advisor review, or blocked by missing source. That keeps the workflow from feeling like a black box and prevents the agent from turning uncertainty into false confidence.
