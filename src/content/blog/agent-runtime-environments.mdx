...
Start with [OpenAI-compatible routers](/blog/openai-compatible-routers-for-agents), [AI agent sandbox](/blog/ai-agent-sandbox), and [Browser Agent](https://github.com/tangle-network/browser-agent-driver). The self-improving stack series covers deeper runtime patterns in [agent runtime topology](/blog/self-improving-stack-agent-runtime-topology), [trace systems](/blog/self-improving-stack-trace-systems), and [evaluation gates](/blog/self-improving-stack-evaluation-gates).
