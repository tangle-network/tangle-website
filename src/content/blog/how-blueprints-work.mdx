...
This is where Tangle's blueprints come in. They provide the execution layer that x402 payments pay for, with built-in [verification](/post/how-tangle-verifies-work) and economic consequences for misbehavior.
...
**For TEE execution:** Check the attestation. Hardware manufacturers sign attestations proving code ran inside an enclave. See [Trusted Execution on Tangle](/post/trusted-execution-on-tangle) for how the SDK integrates TEE across cloud providers.
